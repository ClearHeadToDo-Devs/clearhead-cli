...
fn main() {
    ...
    println!("{}", format(&actions, OutputFormat::Actions, None, None).unwrap());

    println!("\n=== JSON FORMAT ===");
    println!("{}", format(&actions, OutputFormat::Json, None, None).unwrap());

    println!("\n=== XML FORMAT ===");
    println!("{}", format(&actions, OutputFormat::Xml, None, None).unwrap());

    println!("\n=== TABLE FORMAT ===");
    println!("{}", format(&actions, OutputFormat::Table, None, None).unwrap());
}
